...
import { getLiveProducts } from "./shopifyClient";
import { getScrapedRecipes } from "./recipeScraper";

// Caches are seeded from static JSON; live services refresh them on startup.
// All lookup functions stay synchronous — they read from the live caches.
function products(): Product[] { return getLiveProducts(); }
function recipes(): Recipe[] { return getScrapedRecipes(); }
